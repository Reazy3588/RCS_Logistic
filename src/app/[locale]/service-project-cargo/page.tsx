...
export async function generateMetadata({
    ...
    const t = await getTranslations({ locale, namespace: "projectCargo" });
    return {
...
export default function Page() {
    const t = useTranslations("projectCargo");
            ...
            <section className="page-header" style={{ backgroundImage: "url('/images/img(11).jpg')" }}>
                <div className="container page-header-content">
                    ...
                    <div className="breadcrumb">
                        ...
                        <span className="breadcrumb-icon"><i className="fa-solid fa-angle-right"></i></span>
                        <span>{t("breadcrumbProjectCargo")}</span>
                    </div>
                </div>
            </section>
                        ...
                        <div className="col-lg-4 mb-5 mb-lg-0 order-2 order-lg-1">
                            ...
                            <div className="sidebar-widget">
                                ...
                                <ul className="cat-list service-list-widget">
                                    ...
                                    <li><Link href={withLocale("/service-project-cargo")} className="active">{t("navProjectCargo")}<i className="fa-solid fa-arrow-right"></i></Link></li>
                                ...
                                <div className="row my-5">
                                    ...
                                    <div className="col-md-6">
                                        ...
                                        <ul className="check-list dark-text mt-4">
                                            <li><i className="fa-solid fa-check"></i><span>{t("checkHeavyLift")}</span></li>
                                            <li><i className="fa-solid fa-check"></i><span>{t("checkFeasibility")}</span></li>
                                            <li><i className="fa-solid fa-check"></i><span>{t("checkTurnkey")}</span></li>
                                            <li><i className="fa-solid fa-check"></i><span>{t("checkPermits")}</span></li>
                                        </ul>
                                    </div>
                                </div>
