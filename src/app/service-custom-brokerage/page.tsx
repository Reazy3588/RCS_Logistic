        ...
        <>
            <section className="page-header" style={{ backgroundImage: "url('/images/img(11).jpg')" }}>
                <div className="container page-header-content">
                    <h1 className="page-title">Customs Brokerage</h1>
                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-4 mb-5 mb-lg-0 order-2 order-lg-1">
                            ...
                            <div className="sidebar-widget">
                                ...
                                <ul className="cat-list service-list-widget">
                                    ...
                                    <li><Link href="/service-custom-brokerage" className="active">Customs Brokerage<i className="fa-solid fa-arrow-right"></i></Link></li>
                        ...
                        <div className="col-lg-8 ps-lg-5 order-1 order-lg-2">
                            ...
                            <div className="service-detail-content">
                                <h2 className="mb-4">Customs Brokerage Services</h2>
                                <p>RCS Logistics Cambodia provides reliable customs brokerage services, ensuring compliant and efficient import and export clearance to support seamless cargo movement across Cambodia’s key logistics gateways.</p>
                                <p>RCS Logistics Cambodia also provides dependable cross-border logistics solutions connecting Cambodia with regional markets through efficient transportation, customs expertise, and end-to-end cargo coordination.</p>
                                ...
                                <div className="row my-5">
                                    ...
                                    <div className="col-md-6">
                                        <h3 className="mb-3">Why Choose Our Brokerage?</h3>
                                        <p>We simplify the customs process, ensuring compliance and speed for your international shipments.</p>
                                        <ul className="check-list dark-text mt-4">
                                            <li><i className="fa-solid fa-check"></i><span>Licensed Customs Brokers</span></li>
                                            <li><i className="fa-solid fa-check"></i><span>Tariff Classification Expertise</span></li>
                                            <li><i className="fa-solid fa-check"></i><span>Import/Export Documentation</span></li>
                                            <li><i className="fa-solid fa-check"></i><span>Duty & Tax Calculation</span></li>
                                        </ul>
                                    </div>
                                </div>

                                <h3 className="mb-4">How It Works</h3>
                                <p className="mb-5">Our customs clearance process is integrated into our shipping services, providing a seamless experience from origin to destination.</p>
