...
export const metadata: Metadata = {
  title: "Cargonz - Premium Global Logistics",
                  ...
                  <div className="hero-split-left">
                      <div className="hero-content hero-enter">
                          <div className="hero-label">
                              ...
                              <span className="label-text">Logistics Reimagined</span>
                          </div>
                          <h1 className="hero-title">
                              <span className="title-line">Precision Delivery.</span>
                              <span className="title-line">Beautifully Simple.</span>
                          </h1>
                          <p className="hero-description mb-5">A premium shipping experience with real-time visibility, clean operations, and dependable performance at global scale.</p>
                          <div className="hero-buttons mb-5">
                              ...
                              <Link href="/contact"  className="btn-hero btn-secondary">Talk to Team</Link>
                          </div>
                          <div className="hero-stats">
                              <div className="stat-item"><span className="stat-number">15K+</span></div>
                              <div className="stat-divider"></div>
                              <div className="stat-item"><span className="stat-number">50+</span></div>
                              <div className="stat-divider"></div>
                              <div className="stat-item"><span className="stat-number">99.3%</span></div>
                          </div>
                      </div>
                  </div>
                  <div className="hero-split-right">
                      <div className="hero-split-img" style={{ backgroundImage: "url('/images/img(2).jpg')" }}></div>
                      <div className="hero-split-shade"></div>
                      <div className="hero-split-card">
                          <span className="hero-split-card-label text-white">Operations Snapshot</span>
                          <h3 className="h4-style text-white">Freight Monitoring Center</h3>
                          <p className="text-white">Track cargo, ETA, and customs status in a unified live dashboard.</p>
                      </div>
                  </div>
              </div>
          </section>
          ...
          <section className="track-stats-section pt-0 pb-0" id="tracking">
              <div className="track-stats-container">
                  ...
                  <div className="stats-box">
                      <Image src="/images/img(10).jpg" alt="Logistics Statistics"  unoptimized width={273} height={329} sizes="100vw" />
