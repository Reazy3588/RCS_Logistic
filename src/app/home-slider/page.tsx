...
export const metadata: Metadata = {
  title: "Home Slider — Cargonz Logistics",
...
<section className="hero-slider-section">
              <div className="swiper home-hero-slider">
                  <div className="swiper-wrapper">
                      <div className="swiper-slide">
                          <div className="hero-slide-bg" style={{ backgroundImage: "url('/images/img(2).jpg')" }}></div>
                          <div className="hero-slide-overlay"></div>
                          <div className="container">
                              <div className="hero-content hero-slider-content hero-enter">
                                  <div className="hero-label">
                                      <span className="label-line"></span>
                                      <span className="label-text">Premium Logistics Network</span>
                                  </div>
                                  <h1 className="hero-title">
                                      <span className="title-line">Move Smarter</span>
                                      <span className="title-line">Deliver Faster</span>
                                  </h1>
                                  <p className="hero-description">High-performance transport solutions engineered for reliability, visibility, and global reach.</p>
                                  <div className="hero-buttons mb-0">
                      ...
                      <div className="swiper-slide">
                          <div className="hero-slide-bg" style={{ backgroundImage: "url('/images/img(9).jpg')" }}></div>
                          <div className="hero-slide-overlay"></div>
                          <div className="container">
                              <div className="hero-content hero-slider-content hero-enter">
                                  <div className="hero-label">
                                      <span className="label-line"></span>
                                      <span className="label-text">Air, Sea, and Land Excellence</span>
                                  </div>
                                  <h1 className="hero-title">
                                      <span className="title-line">End-to-End</span>
                                      <span className="title-line">Supply Chain Control</span>
                                  </h1>
                                  <p className="hero-description">From origin pickup to destination handoff, Cargonz secures every milestone with precision.</p>
                                  <div className="hero-buttons mb-0">
                                      <Link href="/service-details-air"  className="btn-hero btn-primary" data-hover="View Air Cargo"><span>View Air Cargo</span></Link>
                                      <Link href="/contact"  className="btn-hero btn-secondary">Talk to Expert</Link>
                                  </div>
                              </div>
                          </div>
                      </div>
                      <div className="swiper-slide">
                          <div className="hero-slide-bg" style={{ backgroundImage: "url('/images/img(10).jpg')" }}></div>
                          <div className="hero-slide-overlay"></div>
                          <div className="container">
                              <div className="hero-content hero-slider-content hero-enter">
                                  <div className="hero-label">
                                      <span className="label-line"></span>
                                      <span className="label-text">Enterprise Cargo Management</span>
                                  </div>
                                  <h1 className="hero-title">
                                      <span className="title-line">Trusted by Global</span>
                                      <span className="title-line">Trade Leaders</span>
                                  </h1>
                                  <p className="hero-description">Scalable logistics for high-volume operations with premium service standards and dedicated support.</p>
                                  <div className="hero-buttons mb-0">
                                      <Link href="/about"  className="btn-hero btn-primary" data-hover="About Cargonz"><span>About Cargonz</span></Link>
                                      <Link href="/careers"  className="btn-hero btn-secondary">Join Our Team</Link>
                                  </div>
                              </div>
                          </div>
                      </div>
                  ...
                  <div className="hero-slider-nav hero-slider-prev"><i className="fa-solid fa-arrow-left"></i></div>
                  <div className="hero-slider-nav hero-slider-next"><i className="fa-solid fa-arrow-right"></i></div>
              </div>
          </section>
