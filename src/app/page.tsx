                ...
                <div className="container">
                    <div className="hero-content hero-enter">
                        <div className="hero-label">
                            ...
                            <span className="label-text">Worldwide Freight Solutions</span>
                        </div>
                        <h1 className="hero-title">
                            <span className="title-line">Reliable Logistics</span>
                            <span className="title-line title-line-accent">& Transport Services</span>
                        </h1>
                        <p className="hero-description">We provide fast, safe, and secure transportation services for your business needs. From ocean freight to air cargo, we handle it all with precision.</p>
                        <div className="hero-buttons">
                            <a href="#services" className="btn-hero btn-primary" data-hover="Explore Services"><span>Explore Services</span></a>
                            {/* <a href="#tracking" className="btn-hero btn-secondary">Track Shipment</a> */}
                        </div>
                        <div className="hero-stats">
                            <div className="stat-item"><span className="stat-number"><span className="counter-animate" data-target="15">0</span>K+</span><span className="stat-label">Delivered Shipments</span></div>
                            <div className="stat-divider"></div>
                            <div className="stat-item"><span className="stat-number"><span className="counter-animate" data-target="50">0</span>+</span><span className="stat-label">Countries Served</span></div>
                            <div className="stat-divider"></div>
                            <div className="stat-item"><span className="stat-number"><span className="counter-animate" data-target="24">0</span>/7</span><span className="stat-label">Support Available</span></div>
                        </div>
                    </div>
                </div>
            </section>
                    ...
                    <div className="stats-box">
                        ...
                        <div className="stats-grid">
                            <div className="stat-card">
                                <div className="stat-value"><span className="counter-animate" data-target="19">0</span></div>
            ...
            <section className="why-choose-section">
                ...
                <div className="container">
                    <div className="why-choose-content">
                        ...
                        <p className="why-choose-desc">With over 19 years of experience in the logistics industry, we have built a reputation for reliability, efficiency, and customer satisfaction.</p>
